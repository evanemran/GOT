...
class AppTheme{
  ...
  TextStyle(fontSize: 20.0,fontWeight:FontWeight.bold, color: Colors.brown,fontFamily: "Roboto");

  static final TextStyle readMoreText =
  TextStyle(fontSize: 14.0,fontWeight:FontWeight.bold, color: Colors.brown,fontFamily: "Roboto");
